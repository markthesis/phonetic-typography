function variableType(input, weight, tall) {
  if (input == " ") {
    ...
    xPos += 0.5*tracking;
    apostrophe(xPos, yPos, weight, tall);
    xPos += 0.5*tracking;
  }
}
...
function B(x, y, weight, tall) {
  ...
  beginShape();
  vertex(2*size, 0);
  bezierVertex(6*size + 1*weight, 0, 9*size + 2*weight, -3*size - 1*weight, 9*size + 2*weight, -7*size - 2*weight);
  vertex(9*size + 2*weight, -10*size - 1*weight - 5*tall);
  bezierVertex(9*size + 2*weight, -12*size - 0.5*weight - 5*tall, 8*size + 2*weight, -14*size - 2*weight - 5*tall, 6*size + 2*weight, -15*size - 2*weight - 5*tall);
  bezierVertex(8*size + 2*weight, -16*size - 2*weight - 5*tall, 9*size + 2*weight, -18*size - 2.5*weight - 5*tall,9*size + 2*weight, -20*size - 3*weight - 5*tall);
  vertex(9*size + 2*weight, -23*size - 2*weight - 10*tall);
  bezierVertex(9*size + 2*weight, -27*size - 3*weight - 10*tall, 6*size + 1*weight, -30*size - 4*weight - 10*tall, 2*size, -30*size - 4*weight - 10*tall);
  ...
  bezierVertex(2.25*size - 0.75*weight, -12*size - 5*tall, 3*size - 2*weight, -11.25*size + 0.75*weight - 5*tall, 3*size - 2*weight, -10*size - 1*weight - 5*tall);
  vertex(3*size - 2*weight, -8*size - 3*weight);
  bezierVertex(3*size - 2*weight, -6.75*size - 3.75*weight, 2.25*size - 1.75*weight, -6*size - 4*weight, size - 1*weight, -6*size - 4*weight);
  endContour();
  ...
  bezierVertex(2.25*size - 0.75*weight, -24*size - 10*tall, 3*size - 2*weight, -23.25*size + 0.75*weight - 10*tall, 3*size - 2*weight, -22*size - 1*weight - 10*tall);
  vertex(3*size - 2*weight, -20*size - 3*weight - 5*tall);
  bezierVertex(3*size - 2*weight, -18.75*size - 3.75*weight - 5*tall, 2.25*size - 1.75*weight, -18*size - 4*weight - 5*tall, size - 1*weight, -18*size - 4*weight - 5*tall);
  endContour();
...
function C(x, y, weight, tall) {
  ...
  beginShape();
  vertex(2*size, 0);
  bezierVertex(6*size + weight, 0, 9*size + 2*weight, -3*size - weight, 9*size + 2*weight, -7*size - 2*weight);
  vertex(9*size + 2*weight, -10*size - 2*weight - 3*tall);
  vertex(3*size - 2*weight, -10*size - 2*weight - 3*tall);
  vertex(3*size - 2*weight, -8*size - 3*weight);
  bezierVertex(3*size - 2*weight, - 6.75*size - 3.75*weight, 2.25*size - 1.75*weight, -6*size - 4*weight, size - weight, -6*size - 4*weight);
  vertex(-size + weight, -6*size - 4*weight);
  bezierVertex(-2.25*size + 1.75*weight, -6*size - 4*weight, -3*size + 2*weight, - 6.75*size - 3.75*weight, -3*size + 2*weight, -8*size - 3*weight);
  vertex(-3*size + 2*weight, -22*size - weight - 10*tall);
  bezierVertex(-3*size + 2*weight, -23.25*size - 0.25*weight - 10*tall, -2.25*size + 1.75*weight, -24*size - 10*tall, -size + weight, -24*size - 10*tall);
  vertex(size - weight, -24*size - 10*tall);
  bezierVertex(2.25*size - 1.75*weight, -24*size - 10*tall, 3*size - 2*weight, -23.25*size - 0.25*weight - 10*tall, 3*size - 2*weight, -22*size - weight - 10*tall);
  vertex(3*size - 2*weight, -20*size - 2*weight - 7*tall);
  vertex(9*size + 2*weight, -20*size - 2*weight - 7*tall);
  vertex(9*size + 2*weight, -23*size - 2*weight - 10*tall);
  bezierVertex(9*size + 2*weight, -27*size - 3*weight - 10*tall, 6*size + weight, -30*size - 4*weight - 10*tall, 2*size, -30*size - 4*weight - 10*tall);
  vertex(-2*size, -30*size - 4*weight - 10*tall);
  bezierVertex(-6*size - weight, -30*size - 4*weight - 10*tall, -9*size - 2*weight, -27*size - 3*weight - 10*tall, -9*size - 2*weight, -23*size - 2*weight - 10*tall);
  vertex(-9*size - 2*weight, -7*size - 2*weight);
  bezierVertex(-9*size - 2*weight, -3*size - weight, -6*size - weight, 0, -2*size, 0);
  endShape(CLOSE);
...
function P(x, y, weight, tall) {
  ...
  bezierVertex(6*size + weight, -8*size - 5*tall, 9*size + 2*weight, -11*size - weight - 5*tall, 9*size + 2*weight, -15*size - 2*weight - 5*tall);
  vertex(9*size + 2*weight, -23*size - 2*weight - 10*tall);
  bezierVertex(9*size + 2*weight, -27*size - 3*weight - 10*tall, 6*size + weight, -30*size - 4*weight - 10*tall, 2*size, -30*size - 4*weight - 10*tall);
  vertex(-9*size - 2*weight, -30*size - 4*weight - 10*tall);
  vertex(-9*size - 2*weight, 0);
  ...
  bezierVertex(3*size - 2*weight, - 14.75*size - 3.75*weight - 5*tall, 2.25*size - 1.75*weight, -14*size - 4*weight - 5*tall, size - weight, -14*size - 4*weight - 5*tall);
  vertex(-3*size + 2*weight, -14*size - 4*weight - 5*tall);
  vertex(-3*size + 2*weight, -24*size - 10*tall);
  vertex(size - weight, -24*size - 10*tall);
  bezierVertex(2.25*size - 1.75*weight, -24*size - 10*tall, 3*size - 2*weight, -23.25*size - 0.25*weight - 10*tall, 3*size - 2*weight, -22*size - weight - 10*tall);
...
function Q(x, y, weight, tall) {
  ...
  bezierVertex(8*size + 3*weight, -2*size - 2*weight, 9*size + 2*weight, -3*size - weight, 9*size + 2*weight, -7*size - 2*weight);
...
function S(x, y, weight, tall) {
  ...
  bezierVertex(9*size + 2*weight, -13*size - 2*weight - 5*tall, 7*size + 2*weight, -15*size - 3*weight - 5*tall, 5*size + 2*weight + 0.375*tall, -16*size - 3*weight - 4.8*tall);

  vertex(-size + 2.5*weight - 0.1*tall, -18.5*size - 3*weight - 6.5*tall);

  bezierVertex(-2*size + 2.5*weight, -19*size - 3*weight - 6.5*tall, -3*size + 2*weight, -19.5*size - 3*weight - 6.5*tall, -3*size + 2*weight, -20.5*size - 3*weight - 7*tall);
  ...
  bezierVertex(-9*size - 2*weight, -17*size - 1*weight - 6*tall, -7*size - 2.4*weight - 0.4*tall, -15*size - 1.5*weight - 7*tall, -5*size - 1.5*weight + 0.05*tall, -14*size - 0.4*weight - 6.0*tall);

  vertex(size - 1.5*weight + 0*tall, -11*size - 5.3*tall);

  bezierVertex(2*size - 2*weight + 0.2*tall, -10.5*size + 0*weight - 4.7*tall, 3*size - 2*weight -0.0*tall, -10*size - 4*tall, 3*size - 2*weight, -9*size - 0*weight - 4*tall);
...
function apostrophe(x, y, weight, tall) {
  push();
  translate(x, y);
